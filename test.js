// fetch(`http://site.api.espn.com/apis/site/v2/sports/football/college-football/summary?event=${searchTerm}`)
//     .then((result) => {
//         return result.json();
//     })
//     .then((result) => {
...
// function init(data) {
//   const gameWrapper = document.querySelector("gameInfoContainer");
//   const renderToDom = (resultsString) => {
//     gameWrapper.innerHTML += resultsString;
...
//             const HtmlString = resultsHtmlRepresentation(gameObj);
...
//         var sectionContainer = document.getElementById("gameInfoContainer");
//         sectionContainer.style.display = "flex"; // <-- Set it to inline-flex
